...
static variable_name_t VariableNameTable[eMSDP_MAX+1] = 
{
   ...
   { eMSDP_BRG,             "BRG",            NUMBER_READ_ONLY },
   { eMSDP_BRG_MAX,         "BRG_MAX",        NUMBER_READ_ONLY },
   { eMSDP_WILLPOWER,       "WILLPOWER",      NUMBER_READ_ONLY },
   { eMSDP_WILLPOWER_MAX,   "WILLPOWER_MAX",  NUMBER_READ_ONLY },
   { eMSDP_CLAN,         "CLAN",        STRING_READ_ONLY },
   { eMSDP_DOLLARS,         "DOLLARS",        NUMBER_READ_ONLY },
   { eMSDP_CENTS,        "CENTS",          NUMBER_READ_ONLY },
   { eMSDP_STA,             "STA",         NUMBER_READ_ONLY },
   { eMSDP_CHA,             "CHA",         NUMBER_READ_ONLY },
   { eMSDP_MAN,             "MAN",         NUMBER_READ_ONLY },
   { eMSDP_APP,             "APP",         NUMBER_READ_ONLY },
   { eMSDP_PER,             "PER",            NUMBER_READ_ONLY },
   { eMSDP_WIT,             "WIT",            NUMBER_READ_ONLY },
   { eMSDP_GEN,             "GEN",            NUMBER_READ_ONLY },
   { eMSDP_GHB,             "GHB",            NUMBER_READ_ONLY },
   { eMSDP_GHB_MAX,         "GHB_MAX",        NUMBER_READ_ONLY },
   { eMSDP_HEALTH,          "HEALTH",         STRING_READ_ONLY },
   { eMSDP_AUSPICE,         "AUSPICE",        STRING_READ_ONLY },
   { eMSDP_BREED,        "BREED",          STRING_READ_ONLY },
...
static void SendMSSP( descriptor_t *apDescriptor )
{
   ...
   static MSSP_t MSSPTable[] =
   {
      ...
      /* Generic */
      { "CRAWL DELAY",        "-1" },
      { "HOSTNAME",           "brandonsplace.net" },
      { "PORT",               "9085" },
      { "CODEBASE",           "ProjectTwilight 1.0" },
      { "CONTACT",            "ptrayal@gmail.com" },
      { "LANGUAGE",           "English" },
      { "LOCATION",           "USA" },
      { "MINIMUM AGE",        "0" },
      { "WEBSITE",            "http://www.brandonsplace.net/projecttwilight" },
/*
      { "CREATED",            "" },
      { "ICON",               "" },
      { "IP",                 "" },
