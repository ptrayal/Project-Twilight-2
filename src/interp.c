...
/* 		{ "vlist",	do_vlist,	P_DEAD,		WA, L_NRM, 1, A|B, 0},*/
	...
	{	"arealinks",		do_arealinks,		P_DEAD,	WA,	L_ALL,	1,	A|B,	0 },
	...
	{	"ritedit",			do_ritedit,			P_DEAD,	IM,	L_NRM,	2,	A|B,	0 },
	{	"ritesave",			do_ritesave,		P_DEAD,	IM,	L_NRM,	1,	A|B,	0 },
	...
	{	"testcommand",		do_testarray,	P_DEAD, IM, L_NRM,	1,	A|B|E,	0 },

// Changes Board
	{	"addchange",			do_addchange,				P_DEAD,	MA,	L_ALL,	1,	A|B|E,	0 },
	{	"delchange",			do_delchange,				P_DEAD,	MA,	L_ALL,	1,	A|B|E,	0 },
	{	"changes",				do_nchange,					P_DEAD,	0,	L_ALL,	1,	A|B|E,	0 },
